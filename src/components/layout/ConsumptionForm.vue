...
export default {
    ...
    data: () => {
        return {
            ...
            data: [], // data for vue2-datatable-component
    ...
    mounted: function()    {
        ...
        let query = jQuery.param(Vue._.pickBy(this.query)) // получаем строку параметров, удалив предварительно пустые параметры или равные null
        console.log(this.api_consumptions + '/index?' + query)
